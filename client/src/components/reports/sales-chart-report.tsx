...
export function SalesChartReport() {
  ...
  const { data: products } = useQuery({
    ...
    queryFn: async () => {
      const response = await fetch(
        `https://c4a08644-6f82-4c21-bf98-8d382f0008d1-00-2q0r6kl8z7wo.pike.replit.dev/api/products/${selectedCategory}/${productType}/${productSearch || ""}`,
      );
    ...
    useQuery({
      ...
      queryFn: async () => {
        try {
          ...
          const response = await fetch(
            `https://c4a08644-6f82-4c21-bf98-8d382f0008d1-00-2q0r6kl8z7wo.pike.replit.dev/api/product-analysis/${encodeURIComponent(startDateTimeLocal)}/${encodeURIComponent(endDateTimeLocal)}${floorFilter}?${params}`,
            {
              method: "GET",
              headers: {
