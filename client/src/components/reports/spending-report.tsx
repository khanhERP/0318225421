...
export function SpendingReport() {
  ...
  const {
    ...
    queryKey: ["https://c4a08644-6f82-4c21-bf98-8d382f0008d1-00-2q0r6kl8z7wo.pike.replit.dev/api/purchase-receipts", { startDate, endDate }],
    queryFn: async () => {
  ...
  const { data: expenseVouchers = [], refetch: refetchExpenseVouchers } =
    useQuery({
      queryKey: ["https://c4a08644-6f82-4c21-bf98-8d382f0008d1-00-2q0r6kl8z7wo.pike.replit.dev/api/expense-vouchers", { startDate, endDate }],
      queryFn: async () => {
        const params = new URLSearchParams();
  ...
  const { data: orders = [], refetch: refetchOrders } = useQuery({
    queryKey: ["https://c4a08644-6f82-4c21-bf98-8d382f0008d1-00-2q0r6kl8z7wo.pike.replit.dev/api/orders/date-range", startDate, endDate],
    queryFn: async () => {
      const response = await fetch(
