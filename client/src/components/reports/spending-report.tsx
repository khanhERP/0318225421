...
export function SpendingReport() {
  ...
  const {
    ...
    queryFn: async () => {
      ...
      console.log("📊 Fetching purchase receipts with date filter:", {
        startDate,
        endDate,
        url: `https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.dev/api/purchase-receipts?${params.toString()}`,
      });
    ...
    useQuery({
      ...
      queryFn: async () => {
        ...
        console.log("💰 Fetching expense vouchers with date filter:", {
          startDate,
          endDate,
          url: `https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.dev/api/expense-vouchers?${params.toString()}`,
        });
  ...
  const { data: orders = [], refetch: refetchOrders } = useQuery({
    queryKey: ["https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.dev/api/orders/date-range", startDate, endDate],
    queryFn: async () => {
      const response = await fetch(
