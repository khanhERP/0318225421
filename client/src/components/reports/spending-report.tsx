...
export function SpendingReport() {
  ...
  const {
    ...
    queryKey: ["https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.devapi/purchase-receipts", { startDate, endDate }],
    queryFn: async () => {
      ...
      console.log("📊 Fetching purchase receipts with date filter:", {
        startDate,
        endDate,
        url: `https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.devapi/purchase-receipts?${params.toString()}`,
      });

      const response = await fetch(
        `https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.devapi/purchase-receipts?${params.toString()}`,
      );
  ...
  const { data: expenseVouchers = [], refetch: refetchExpenseVouchers } =
    useQuery({
      queryKey: ["https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.devapi/expense-vouchers", { startDate, endDate }],
      queryFn: async () => {
        const params = new URLSearchParams();
        ...
        console.log("💰 Fetching expense vouchers with date filter:", {
          startDate,
          endDate,
          url: `https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.devapi/expense-vouchers?${params.toString()}`,
        });

        const response = await fetch(
          `https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.devapi/expense-vouchers?${params.toString()}`,
        );
  ...
  const { data: orders = [], refetch: refetchOrders } = useQuery({
    queryKey: ["https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.devapi/orders/date-range", startDate, endDate],
    queryFn: async () => {
      const response = await fetch(
