...
function MenuReport() {
  ...
  const { data: categories = [] } = useQuery({
    ...
    queryFn: async () => {
      try {
        const response = await apiRequest("GET", "https://64071157-147f-4160-96cd-6dc099d777d2-00-1d0mzv8b48h7n.pike.replit.dev/api/categories");
    ...
    queryFn: async () => {
      try {
        ...
        const response = await apiRequest(
          "GET",
          `https://64071157-147f-4160-96cd-6dc099d777d2-00-1d0mzv8b48h7n.pike.replit.dev/api/products/${selectedCategory}/${productType}/${searchParam}`,
        );
  ...
  const {
    ...
    queryKey: ["https://64071157-147f-4160-96cd-6dc099d777d2-00-1d0mzv8b48h7n.pike.replit.dev/api/menu-analysis", startDate, endDate, selectedCategory],
    queryFn: async () => {
      try {
        ...
        const response = await apiRequest(
          "GET",
          `https://64071157-147f-4160-96cd-6dc099d777d2-00-1d0mzv8b48h7n.pike.replit.dev/api/menu-analysis?${params.toString()}`,
        );
        if (!response.ok) {
          console.error(
        ...
        <CardHeader>
          <CardTitle className="flex items-center justify-between">
            ...
            <Button
              onClick={() => {
                refetch();
                queryClient.invalidateQueries({ queryKey: ["https://64071157-147f-4160-96cd-6dc099d777d2-00-1d0mzv8b48h7n.pike.replit.dev/api/menu-analysis"] });
              }}
              variant="outline"
              size="sm"
