...
function MenuReport() {
  ...
  const { data: categories = [] } = useQuery({
    ...
    queryFn: async () => {
      try {
        const response = await apiRequest("GET", "api-demo.edpos.vn/api/categories");
  ...
  const { data: products = [] } = useQuery({
    queryKey: ["api-demo.edpos.vn/api/products", selectedCategory, productType, productSearch],
    queryFn: async () => {
      try {
        ...
        const response = await apiRequest(
          "GET",
          `api-demo.edpos.vn/api/products/${selectedCategory}/${productType}/${searchParam}`,
        );
  ...
  const {
    ...
    queryKey: [
      "api-demo.edpos.vn/api/menu-analysis",
      startDate,
      endDate,
      selectedCategory,
      productSearch,
    ...
    queryFn: async () => {
      try {
        ...
        const response = await apiRequest(
          "GET",
          `api-demo.edpos.vn/api/menu-analysis?${params.toString()}`,
        );
        if (!response.ok) {
          console.error(
  ...
  const handleRefresh = () => {
    ...
    queryClient.invalidateQueries({ queryKey: ["api-demo.edpos.vn/api/orders/date-range"] });
    queryClient.invalidateQueries({
      queryKey: ["api-demo.edpos.vn/api/order-items/date-range"],
    });
  };
