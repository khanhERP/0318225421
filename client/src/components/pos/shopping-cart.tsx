...
export function ShoppingCart({
  ...
  const { data: userInfo } = useQuery({
    queryKey: ["user-info"],
    queryFn: async () => {
      const response = await fetch("https://c4a08644-6f82-4c21-bf98-8d382f0008d1-00-2q0r6kl8z7wo.pike.replit.dev/api/auth/me");
      if (!response.ok) {
  ...
  const fetchCustomers = async (searchTerm: string) => {
    try {
      ...
      const response = await fetch(
        `https://c4a08644-6f82-4c21-bf98-8d382f0008d1-00-2q0r6kl8z7wo.pike.replit.dev/api/customers?search=${encodeURIComponent(searchTerm)}`,
        {
          method: "GET",
          headers: {
  ...
  const handlePlaceOrder = async () => {
    ...
    try {
      const orderNumberResponse = await fetch("https://c4a08644-6f82-4c21-bf98-8d382f0008d1-00-2q0r6kl8z7wo.pike.replit.dev/api/orders/next-order-number");
