  ...
  const handlePrint = async () => {
    ...
    try {
      ...
      if (receiptData.orderId && receiptData.orderId !== 'temp-order') {
        ...
        try {
          const statusResponse = await fetch(`api-demo.edpos.vn/api/orders/${receiptData.orderId}/status`, {
            method: 'PUT',
            headers: {
      ...
      try {
        ...
        const printApiResponse = await fetch('api-demo.edpos.vn/api/pos/print-receipt', {
          method: 'POST',
          headers: {
            'Content-Type': 'application/json',
          },
