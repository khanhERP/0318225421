...
export function SupplierFormModal({ isOpen, onClose, supplier }: SupplierFormModalProps) {
  ...
  const { data: suppliers } = useQuery({
    ...
    queryFn: async () => {
      const response = await apiRequest('GET', 'https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.devapi/suppliers');
      return response.json();
    },
  });
  ...
  const createMutation = useMutation({
    mutationFn: async (data: InsertSupplier) => {
      ...
      const response = await apiRequest('POST', 'https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.devapi/suppliers', dataWithStoreCode);
      return response.json();
    },
    onSuccess: () => {
  ...
  const updateMutation = useMutation({
    mutationFn: async (data: Partial<InsertSupplier>) => {
      const response = await apiRequest('PUT', `https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.devapi/suppliers/${supplier!.id}`, data);
      return response.json();
    },
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.devapi/suppliers'] });
