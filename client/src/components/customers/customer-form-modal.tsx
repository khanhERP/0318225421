...
export function CustomerFormModal({
  ...
  const { data: orderHistory, isLoading: ordersLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      const response = await apiRequest("GET", `https://api-demo.edpos.vn/api/orders`);
  ...
  const generateCustomerId = async () => {
    try {
      const response = await apiRequest("GET", "https://api-demo.edpos.vn/api/customers/next-id");
  ...
  const createMutation = useMutation({
    mutationFn: async (data: CustomerFormData) => {
      ...
      const response = await apiRequest("POST", "https://api-demo.edpos.vn/api/customers", cleanData);
  ...
  const updateMutation = useMutation({
    mutationFn: async (data: CustomerFormData) => {
      ...
      const response = await apiRequest(
        "PUT",
        `https://api-demo.edpos.vn/api/customers/${customer.id}`,
        cleanData,
      );
      return response.json();
    },
  ...
  const onSubmit = async (data: CustomerFormData) => {
    ...
    if (customer?.id) {
      ...
      if (!customerIdToUse || customerIdToUse === t("common.autoGenerated")) {
        try {
          const response = await fetch("https://api-demo.edpos.vn/api/customers/next-id");
