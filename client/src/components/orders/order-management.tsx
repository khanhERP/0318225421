...
export function OrderManagement() {
  ...
  const { data: orders, isLoading: ordersLoading } = useQuery({
    ...
    queryFn: async () => {
      const response = await apiRequest('GET', 'https://bad07204-3e0d-445f-a72e-497c63c9083a-00-3i4fcyhnilzoc.pike.replit.dev/api/orders?salesChannel=table');
      if (!response.ok) {
  ...
  const { data: orderItems, isLoading: orderItemsLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      try {
        const response = await apiRequest('GET', `https://bad07204-3e0d-445f-a72e-497c63c9083a-00-3i4fcyhnilzoc.pike.replit.dev/api/order-items/${selectedOrder.id}`);
        if (!response.ok) {
  ...
  const completeOrderPayment = async (orderId: number, paymentData: any) => {
    ...
    try {
      ...
      const statusResponse = await apiRequest('PUT', `https://bad07204-3e0d-445f-a72e-497c63c9083a-00-3i4fcyhnilzoc.pike.replit.dev/api/orders/${orderId}/status`, { status: 'paid' });
  ...
  const handleStatusUpdate = async (orderId: number, newStatus: string) => {
    try {
      ...
      const response = await apiRequest('PUT', `https://bad07204-3e0d-445f-a72e-497c63c9083a-00-3i4fcyhnilzoc.pike.replit.dev/api/orders/${orderId}/status`, { status: newStatus });
  ...
  const handlePaymentClick = async (order: Order) => {
    ...
    try {
      ...
      const orderItemsResponse = await apiRequest('GET', `https://bad07204-3e0d-445f-a72e-497c63c9083a-00-3i4fcyhnilzoc.pike.replit.dev/api/order-items/${order.id}`);
