...
export default function Settings() {
  ...
  const handleCreateProduct = async () => {
    ...
    try {
      ...
      const response = await apiRequest("POST", "https://bad07204-3e0d-445f-a72e-497c63c9083a-00-3i4fcyhnilzoc.pike.replit.dev/api/products", productData);
  ...
  const handleUpdateProduct = async () => {
    ...
    try {
      ...
      const response = await apiRequest(
        "PUT",
        `https://bad07204-3e0d-445f-a72e-497c63c9083a-00-3i4fcyhnilzoc.pike.replit.dev/api/products/${editingProduct.id}`,
        productData,
      );
      queryClient.invalidateQueries({ queryKey: ["https://bad07204-3e0d-445f-a72e-497c63c9083a-00-3i4fcyhnilzoc.pike.replit.dev/api/products"] });
      toast({
