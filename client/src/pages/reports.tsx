...
export default function ReportsPage({ onLogout }: ReportsPageProps) {
  ...
  const { data: ordersData } = useQuery({
    queryKey: ["https://796f2db4-7848-49ea-8b2b-4c67f6de26d7-00-248bpbd8f87mj.sisko.replit.dev/api/orders/list", startDate, endDate, storeFilter],
    queryFn: async () => {
      ...
      console.log("🔍 Overview tab - Fetching orders with params:", {
        ...
        url: `https://796f2db4-7848-49ea-8b2b-4c67f6de26d7-00-248bpbd8f87mj.sisko.replit.dev/api/orders/list?${params}`,
      });

      const response = await fetch(`https://796f2db4-7848-49ea-8b2b-4c67f6de26d7-00-248bpbd8f87mj.sisko.replit.dev/api/orders/list?${params}`);
