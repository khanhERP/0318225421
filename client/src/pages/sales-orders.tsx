...
export default function SalesOrders() {
  ...
  useEffect(() => {
    ...
    const handleEInvoiceModalClosed = async (event: CustomEvent) => {
      ...
      queryClient.removeQueries({ queryKey: ["https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.dev/api/order-items"] });
      queryClient.removeQueries({ queryKey: ["https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.dev/api/invoices"] });

      // Force immediate refetch with fresh data
      await Promise.all([
        queryClient.invalidateQueries({ queryKey: ["https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.dev/api/orders"] }),
        queryClient.invalidateQueries({ queryKey: ["https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.dev/api/order-items"] }),
        queryClient.invalidateQueries({ queryKey: ["https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.dev/api/invoices"] }),
        queryClient.invalidateQueries({ queryKey: ["https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.dev/api/tables"] }),
        ...
        queryClient.refetchQueries({ queryKey: ["https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.dev/api/invoices"] }),
      ]);
  ...
  useEffect(() => {
    const handleOrderUpdate = async () => {
      ...
      await queryClient.refetchQueries({
        queryKey: ["https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.dev/api/orders/list"],
        exact: false,
      });
    };
  ...
  const { data: customers = [] } = useQuery({
    ...
    queryFn: async () => {
      try {
        const response = await apiRequest("GET", "https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.dev/api/customers");
        if (!response.ok) {
          throw new Error(`HTTP error! status: ${response.status}`);
        }
        const data = await response.json();
  ...
  const {
    ...
    queryKey: [
      "https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.dev/api/orders/list",
      startDate,
      endDate,
      dateFilterMode,
      customerSearch,
    ...
    queryFn: async () => {
      try {
        ...
        const url = `https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.dev/api/orders/list?${params.toString()}`;
  ...
  const { data: products = [] } = useQuery({
    ...
    queryFn: async () => {
      try {
        const response = await apiRequest("GET", "https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.dev/api/products");
        if (!response.ok) {
          throw new Error(`HTTP error! status: ${response.status}`);
        }
        const data = await response.json();
  ...
  const { data: tables = [] } = useQuery({
    ...
    queryFn: async () => {
      try {
        const response = await apiRequest("GET", "https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.dev/api/tables");
        if (!response.ok) {
          throw new Error(`HTTP error! status: ${response.status}`);
        }
        const data = await response.json();
  ...
  const {
    ...
    queryKey: ["https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.dev/api/order-items", selectedInvoice?.id],
    queryFn: async () => {
      ...
      try {
        const response = await apiRequest(
          "GET",
          `https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.dev/api/order-items/${selectedInvoice.id}`,
        );
  ...
  const updateOrderMutation = useMutation({
    mutationFn: async (updatedOrder: Order) => {
      ...
      const itemsResponse = await apiRequest(
        "GET",
        `https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.dev/api/order-items/${updatedOrder.id}`,
      );
      ...
      const response = await apiRequest(
        "PUT",
        `https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.dev/api/orders/${updatedOrder.id}`,
        updatePayload,
      );
    ...
    onSuccess: async (data, updatedOrder) => {
      ...
      await queryClient.refetchQueries({
        queryKey: ["https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.dev/api/order-items", updatedOrder.id],
      });
  ...
  const bulkCancelOrdersMutation = useMutation({
    ...
    onSuccess: (results) => {
      ...
      queryClient.invalidateQueries({ queryKey: ["https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.dev/api/orders/list"] });
  ...
  const publishRequestMutation = useMutation({
    mutationFn: async (invoiceData: any) => {
      const response = await apiRequest(
        "POST",
        "https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.dev/api/einvoice/publish",
        invoiceData,
      );
      return response.json();
    },
      ...
      if (result.success && selectedInvoice) {
        try {
          ...
          const updateResponse = await apiRequest(
            "PUT",
            `https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.dev/api/orders/${selectedInvoice.id}`,
            updateData,
          );
          console.log(
  ...
  const handleSaveOrder = async () => {
    ...
    try {
      ...
      for (const item of itemsToDelete) {
        ...
        const response = await apiRequest(
          "DELETE",
          `https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.dev/api/order-items/${item.id}`,
        );
        if (!response.ok) {
      ...
      for (const item of itemsToCreate) {
        ...
        const response = await apiRequest(
          "POST",
          `https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.dev/api/order-items/${editableInvoice.id}`,
          payload,
        );
      ...
      const orderUpdateResponse = await apiRequest(
        "PUT",
        `https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.dev/api/orders/${editableInvoice.id}`,
        orderUpdatePayload,
      );
      ...
      if (hasChanges) {
        ...
        try {
          ...
          await apiRequest(
            "POST",
            "https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.dev/api/order-change-history",
      ...
      await Promise.all([
        queryClient.invalidateQueries({ queryKey: ["https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.dev/api/orders"] }),
        queryClient.refetchQueries({ queryKey: ["https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.dev/api/orders/list"] }),
        queryClient.refetchQueries({
          queryKey: ["https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.dev/api/order-items", editableInvoice.id],
        }),
        queryClient.refetchQueries({
          queryKey: [
            "https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.dev/api/orders/date-range",
            startDate,
            endDate,
            currentPage,
            itemsPerPage,
  ...
  const { data: paymentMethodsData = [] } = useQuery({
    ...
    queryFn: async () => {
      try {
        const response = await apiRequest("GET", "https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.dev/api/payment-methods");
        if (!response.ok) {
          throw new Error(`HTTP error! status: ${response.status}`);
        }
        const data = await response.json();
  ...
  const handlePayment = async (order: Invoice) => {
    ...
    try {
      const updateResponse = await apiRequest(
        "PUT",
        `https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.dev/api/orders/${order.id}`,
        {
          paymentStatus: "paid",
          status: "paid",
  ...
  const handlePrintReceipt = async (order: any) => {
    try {
      ...
      const response = await apiRequest("GET", `https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.dev/api/order-items/${order.id}`);
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          >
                            ...
                            <SelectContent side="top">
                              ...
                              <SelectItem value="9999">{t("common.all")}</SelectItem>
                            </SelectContent>
                          </Select>
                          <p className="text-sm font-medium">
                            {t("common.rows")}
