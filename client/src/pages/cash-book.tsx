...
export default function CashBookPage({ onLogout }: CashBookPageProps) {
  ...
  const { data: orders = [] } = useQuery({
    queryKey: ["https://laundry-be-234a.onrender.com/api/orders", startDate, endDate],
    queryFn: async () => {
      try {
        ...
        const response = await fetch(`https://laundry-be-234a.onrender.com/api/orders?${params.toString()}`);
        if (!response.ok)
  ...
  const { data: purchaseReceipts = [] } = useQuery({
    queryKey: ["https://laundry-be-234a.onrender.com/api/purchase-receipts", startDate, endDate],
    queryFn: async () => {
      try {
        const params = new URLSearchParams();
        if (startDate) params.append("startDate", `${startDate} 00:00:00`);
        ...
        const response = await fetch(`https://laundry-be-234a.onrender.com/api/purchase-receipts?${params.toString()}`);
        if (!response.ok)
          throw new Error(`HTTP error! status: ${response.status}`);
        const data = await response.json();
  ...
  const { data: incomeVouchers = [] } = useQuery({
    queryKey: ["https://laundry-be-234a.onrender.com/api/income-vouchers", startDate, endDate],
    queryFn: async () => {
      try {
        const params = new URLSearchParams();
        if (startDate) params.append("startDate", `${startDate} 00:00:00`);
        ...
        const response = await fetch(`https://laundry-be-234a.onrender.com/api/income-vouchers?${params.toString()}`);
        if (!response.ok)
          throw new Error(`HTTP error! status: ${response.status}`);
        const data = await response.json();
        return Array.isArray(data) ? data : [];
  ...
  const { data: expenseVouchers = [] } = useQuery({
    queryKey: ["https://laundry-be-234a.onrender.com/api/expense-vouchers", startDate, endDate],
    queryFn: async () => {
      try {
        const params = new URLSearchParams();
        if (startDate) params.append("startDate", `${startDate} 00:00:00`);
        ...
        const response = await fetch(`https://laundry-be-234a.onrender.com/api/expense-vouchers?${params.toString()}`);
        if (!response.ok)
          throw new Error(`HTTP error! status: ${response.status}`);
        const data = await response.json();
        return Array.isArray(data) ? data : [];
  ...
  const { data: suppliers = [] } = useQuery({
    ...
    queryFn: async () => {
      try {
        const response = await fetch("https://laundry-be-234a.onrender.com/api/suppliers");
        if (!response.ok)
          throw new Error(`HTTP error! status: ${response.status}`);
        const data = await response.json();
        return Array.isArray(data) ? data : [];
