...
export default function PurchasesPage({ onLogout }: PurchasesPageProps) {
  ...
  const {
    ...
    queryFn: async () => {
      ...
      const url = `https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.devapi/purchase-receipts${params.toString() ? `?${params.toString()}` : ""}`;
  ...
  const bulkDeleteMutation = useMutation({
    mutationFn: async (orderIds: number[]) => {
      return apiRequest("POST", "https://870b3a74-08b9-4ccf-b28f-dc7e4de678a7-00-2rac59553o6xa.sisko.replit.devapi/purchase-receipts/bulk-delete", {
        orderIds,
      });
    },
    onSuccess: (data) => {
